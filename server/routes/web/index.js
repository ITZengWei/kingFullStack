module.exports = app => {
	...
	const parent = await Category.findOne({
		...
		/* 取存储的 JSON 数据  不带 mongoose 对象 lean */
		const cats = await Category.find().where({ parent }).lean()
		const newsTitles = ["新皮肤爆料｜掌控万物，武则天化身宇宙女王！", "新皮肤爆料丨守护皇后，黑桃队长鲁班七号待命中", "新星元套装爆料丨大小姐驾到！未来机甲高能预警~", "过年有王者！新春相约峡谷，与你开启福气年", "和“王者荣耀”英雄组团，逛京东，贺新年！", "新皮肤爆料｜掌控万物，武则天化身宇宙女王！", "新皮肤爆料丨守护皇后，黑桃队长鲁班七号待命中", "新星元套装爆料丨大小姐驾到！未来机甲高能预警~", "过年有王者！新春相约峡谷，与你开启福气年", "和“王者荣耀”英雄组团，逛京东，贺新年！", "新皮肤爆料｜掌控万物，武则天化身宇宙女王！", "新皮肤爆料丨守护皇后，黑桃队长鲁班七号待命中", "新星元套装爆料丨大小姐驾到！未来机甲高能预警~", "过年有王者！新春相约峡谷，与你开启福气年", "和“王者荣耀”英雄组团，逛京东，贺新年！", "新皮肤爆料｜掌控万物，武则天化身宇宙女王！", "新皮肤爆料丨守护皇后，黑桃队长鲁班七号待命中", "新星元套装爆料丨大小姐驾到！未来机甲高能预警~", "过年有王者！新春相约峡谷，与你开启福气年", "和“王者荣耀”英雄组团，逛京东，贺新年！",]
	...
	router.get('/news/list', async (req, res) => {
		...
		res.send(cats.map(cat => {
			cat.newsList = cat.newsList.map(news => {
				...
				// news.categoryName = cat.name == '热门' ? '' : cat.name
				return news
			})
			return cat
		}))
	...
	router.get('/articles/:id', async (req, res) => {
		...
		data.related = await Article.find().limit(3)
		res.send(data)
	})
